...
const exportToExcel = () => {
  ...
  const worksheet = XLSX.utils.json_to_sheet(formattedReceipts, { header: [
    'receiptTotalPrice',
...
.text-danger {
  ...
  <v-table class="text-center" style="max-height: 400px; overflow-y: auto;margin-left: 2%; margin-top: 3%;">
    <thead>
      <tr>
