...
const coffeeItems = computed(() =>
  ingredientStore.checkingredient?.checkingredientitem.filter(item => item.type === 'coffee')
);
const riceItems = computed(() =>
  ingredientStore.checkingredient?.checkingredientitem.filter(item => item.type === 'rice')
);
</script>
