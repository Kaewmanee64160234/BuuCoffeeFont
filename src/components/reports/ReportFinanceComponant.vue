...
// import{useReportFinnceStore} from '@/stores/report/report.finance.store'
...
onMounted(async () => {
  ...
  console.log(ReportFinnceStore.getfindToday)
});
          ...
          <v-row>
            <v-col cols="12" md="6">
              <v-card>
                ...
                <template v-if="ReportFinnceStore.cashiers">
                    
                    <v-card-subtitle>เงินต้น : {{ ReportFinnceStore.cashiers.cashierAmount }}</v-card-subtitle>
