          ...
          <div>
            ...
            <v-row class="d-flex align-center justify-start mt-4">
              ...
              <v-col cols="12" md="5" class="d-flex align-center justify-start">
                <v-btn v-if="userStore.currentUser?.userRole !== 'พนักงานขายข้าว'" class="mr-3" icon="mdi-account-plus" color="#ff9800" @click="openCreateCustomerDialog()"></v-btn>
            ...
            <div :class="userStore.currentUser?.userRole === 'พนักงานขายข้าว' ? 'selected-items-list-50' : 'selected-items-list-40'">
                      ...
                      <v-row style="padding: 0;">
                        <v-col cols="7" style="color: gray;font-size: 12px; padding-top: 0;">
                          ...
                          <div v-if="item.productTypeToppings.length > 0">
                            <ul>
                              <li v-for="topping in item.productTypeToppings" :key="topping?.topping?.toppingId" style="font-weight: lighter;color: gray;font-size: 11px;">
            ...
            <div :class="userStore.currentUser?.userRole === 'พนักงานขายข้าว' ? 'summary-section-30' : 'summary-section-25'" style="width: 100%;">
              <v-divider></v-divider>
              <h3>สรุปรายการ</h3>
                ...
                <div>
                    ...
                    <p class="d-flex justify-space-between align-center pr-6 my-2">
                      ...
                      <span style="text-align: start;width: 50%;">
                        <v-responsive class="mx-auto" style="height: 10;">
                          <v-text-field v-model="recive" type="number" variant="solo" name="จำนวนเงิน" label="จำนวนเงิน" id="id"></v-text-field>
                        </v-responsive>
                      </span>
                    </p>
                  </div>
                  ...
                  <div>
                    <p class="d-flex justify-space-between pr-6 my-2">
                      ...
                      <span style="text-align: end;" :class="recive < 0 || recive < posStore.receipt.receiptNetPrice ? 'red--text' : 'black'">{{ parseFloat(change.toFixed(2)) < 0 ? 'จำนวนเงินไม่พอ' : change.toFixed(2) }}</span>
                    </p>
                  </div>
                  <v-divider></v-divider>
                  <v-row class="pt-4">
