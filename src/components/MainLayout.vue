<template>
  ...
  .v-navigation-drawer.rail {
    width: 56px; /* Adjust this width according to your requirements */
  }
  ...
  .v-main {
    ...
    margin-left: 250px; /* Default margin to match the width of the drawer */
  }
  
  .v-main.main-rail {
    margin-left: 56px; /* Margin when the drawer is minimized */
  }
